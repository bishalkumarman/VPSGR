...
bot = telebot.TeleBot('7784809343:AAHiweYumB67l5zMQ3GwPK-amX0O9GLbYMw')

# Admin user IDs
admin_id = ["5027022179"]

# Group and channel details
GROUP_ID = "-1002258062669"
...
def handle_attack(message):
    ...
    if message.chat.id != int(GROUP_ID):
        bot.reply_to(message, "This bot can only be used in the specified group. Join - https://t.me/KINGCHAT7")
        return
